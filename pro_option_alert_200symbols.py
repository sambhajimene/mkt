...
SYMBOLS = {
    ...
    "AMBUJACEM":10,"INDUSTOWER":10,"BOSCHLTD":10,"JUBLFOOD":10,"ASHOKLEY":10,"BAJAJFINSV":10,
...
# You can add more symbols to reach 200+
...
def analyze_symbol(symbol,gap):
    ...
    except: dashboard_data[symbol]={"status":"Data NA"}; return
